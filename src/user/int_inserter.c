#include <xdp/int_inserter.skel.h>
#include <bpf/bpf.h>
...
"XDP program to insert In-Band Network Telemetry(INT) data into packets on interface ingress,"
"then redirect the packets out to another interface.\n"
"Usage: %s <options>\n"
"Required options:\n"
...
static struct int_inserter_bpf *obj;
...
int main(int argc, char **argv)
{
    ...
    obj = int_inserter_bpf__open_and_load();
    ...
    err = int_inserter_bpf__attach(obj);
