...
static int read_int_sample(void *ctx, void *data, size_t length);
...
int main(int argc, char** argv)
{
    ...
    ringbuf = ring_buffer__new(bpf_map__fd(obj->maps.int_ring_buffer), read_int_sample, stdout, NULL);
    ...
    unsigned char full_udp_packet[] = {0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x08,0x00,0x45,0x5c,0x00,0x36,0x00,0x01,0x00,0x00,0x40,0x11,0xf9,0x04,0xc0,0xa8,0x00,0x02,0xc0,0xa8,0x00,0x03,0x17,0x0c,0x17,0x0c,0x00,0x22,0xf5,0x33,0x01,0x00,0x03,0x28,0x10,0x00,0x06,0x0a,0xfc,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x16,0x60,0x4e,0xdb,0x49,0xed,0x95,0xab,0x00,0x00};

    unsigned char full_tcp_packet[] = {0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x08,0x00,0x45,0x5c,0x00,0x66,0x00,0x01,0x00,0x00,0x40,0x06,0xf8,0xdf,0xc0,0xa8,0x00,0x02,0xc0,0xa8,0x00,0x03,0x17,0x0c,0x17,0x0c,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x50,0x00,0x0a,0x00,0x9b,0x54,0x00,0x00,0x01,0x00,0x03,0x28,0x10,0x00,0x06,0x0a,0xfc,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x16,0x60,0x4e,0xdb,0x49,0xed,0x95,0xab,0x00,0x00};

    unsigned char full_short_tcp_packet[] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0xb, 0x0c, 0x08, 0x00, 0x45, 0x5c, 0x00, 0x34, 0x00, 0x01, 0x00, 0x00, 0x40, 0x11, 0xf9, 0x06, 0xc0, 0xa8, 0x00, 0x02, 0xc0, 0xa8, 0x00, 0x03, 0x17, 0x0c, 0x17, 0x0c, 0x00, 0x20, 0xf5, 0x37, 0x01, 0x00, 0x03, 0x28, 0x10, 0x00, 0x06, 0x0a, 0xfc, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x16, 0x60, 0x4e, 0xdb, 0x49, 0xed, 0x95, 0xab};
    ...
    fprintf(stdout, "INT processed: %d\n", obj->bss->int_counter);
    fprintf(stdout, "================================================================================\n");
    fprintf(stdout, "Driver program test run for short tcp...\n");
    fprintf(stdout, "================================================================================\n");
    run_test(prog_fd, full_short_tcp_packet, sizeof(full_short_tcp_packet), 100);
    fprintf(stdout, "Packets processed: %d\n", obj->bss->counter);
    fprintf(stdout, "Packets dropped: %d\n", obj->bss->dropped);
    fprintf(stdout, "INT processed: %d\n", obj->bss->int_counter);
    fprintf(stdout, "================================================================================\n");
